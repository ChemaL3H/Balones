...
const RFID_REGEX = /^\d{19}$/; // clave trasera de la credencial: 19 dígitos, sin más formato
...
form.addEventListener('submit', async (e) => {
    ...
    try {
        // Esperamos a que la autenticación anónima haya terminado antes de escribir,
        // porque las reglas de Firebase ahora exigen "auth != null" en estos nodos.
        await authListo;
