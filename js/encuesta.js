...
form.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        // Paso 2: reservar un balón del inventario general (atómico, nunca baja de 0)
        const resultadoInventario = await runTransaction(inventarioRef, (disponibles) => {
            if (disponibles === null || disponibles <= 0) {
                return; // abortar: no hay balones disponibles
            }
